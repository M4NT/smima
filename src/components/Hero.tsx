  ...
  return (
    <div className="bg-gray-100 min-h-screen py-6 flex flex-col sm:py-12">
      ...
      <div className="flex flex-col items-center sm:flex-row sm:justify-center sm:items-stretch">
        {/* <!-- LEFT --> */}
        <div className="w-5/6 px-4 py-12 text-left sm:w-1/2 sm:max-w-3xl mt-40 ml-20 mr-20">
            ...
            <div className="flex align-left mt-8">
                <button className="inline-flex text-black bg-primary-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Button</button>
            </div>
        </div>
        {/* <!-- RIGHT --> */}
